...
class EditProfile extends Page implements Forms\Contracts\HasForms
{
    ...
    public function mount(): void
    {
        ...
        if (!$this->record) {
            $this->record = Lecturer::create([
                'user_id' => Auth::id(),
                'email' => Auth::user()->email,
                'nama' => Auth::user()->name,
                'status_pengguna' => 'Dosen',
            ]);
    ...
    public function save(): void
    {
        ...
        $this->redirectRoute('filament.user.pages.profile');
    }
    protected function getFormActions(): array
    {
        return [
            Action::make('save')
                ->label('Simpan')
                ->submit('save') // Harus sesuai dengan nama method
