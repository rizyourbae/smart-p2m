...
class ManageOutputs extends EditRecord
{
    protected static string $resource = ProposalResource::class;
    protected static ?string $title = 'Kelola Outputs';
    ...
    {
        return [
            \App\Filament\User\Resources\ProposalResource\RelationManagers\OutputsRelationManager::class,
        ];
    }
