...
class ManageOutcomes extends EditRecord
{
    protected static string $resource = ProposalResource::class;
    protected static ?string $title = 'Kelola Outcomes';
    ...
    {
        return [
            \App\Filament\User\Resources\ProposalResource\RelationManagers\OutcomesRelationManager::class,
        ];
    }
